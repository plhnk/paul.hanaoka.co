...
featuredImage: heart-eyes-for-gatsby.jpg
canonicalLink: https://liferay.design/articles/2020/gatsby-days-la
canonicalTitle: Liferay.Design
tags: ['Gatsby', 'Conference', 'Software Review']
---
...
[apologies to Gatsby’s brand team for the above](gatsby-trifecta.png)
...
[The bathroom would not pass heuristic tests.](soap-or-mouthwash.jpg)
...
[Who doesn't love free swag?](gatsby-swag.png)
...
[ASL Interpreter in the lower left, captioning in the lower right — all around awesome](accessibility-in-action.webp)
