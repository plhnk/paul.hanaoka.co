...
featuredImage: atomic-components.jpg
...
![Lexicon Buttons](buttons-large.png)
...
![Figma Component Symbol](component.png)
...
![Next Component](next-components.png)
_Buy when? Meow!_
...
![More complex components](complex-components.png)
