...
[Source](https://www.smashingmagazine.com/2020/03/designers-code-terminal-text-editors-part-1/ "Permalink to How Should Designers Learn To Code? The Terminal And Text Editors (Part 1) — Smashing Magazine")
...
![Logos and screenshots showing the code behind tools developed by companies like Modulz, Studio.Design, FramerX, and others.][7]Modulz, Studio.Design, FramerX, and other apps — there's still a lot of code in there... ([Large preview][8])
...
![Smashing Editorial][32](mb, yk, il)
