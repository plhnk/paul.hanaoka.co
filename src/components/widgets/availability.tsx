...
export default function StatusIndicator() {
  ...
  return (
    <HoverCard>
      <HoverCardTrigger>
        <span
          className={`mt-6 flex items-center gap-2 small-caps font-mono font-light text-xs px-2.5 py-1 rounded-full outline outline-2 -outline-offset-1 ${outerSpanClasses}`}
        >
          <div
