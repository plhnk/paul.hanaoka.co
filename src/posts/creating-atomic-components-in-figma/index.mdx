...
featuredImage: ./images/atomic-components.jpg
canonicalLink: 'https://liferay.design/articles/2019/creating-atomic-components-in-figma/'
---
...
![Lexicon Buttons](./images/buttons-large.png)
...
![Figma Component Symbol](./images/component.png)
...
![First Component](./images/first-component.png)
_This is the first component_

Your next components will be the content:

![Next Component](./images/next-components.png)
_Buy when? Meow!_
...
![More complex components](./images/complex-components.png)
