...
featuredImage: images/dam-at-liferay.jpeg
...
![Logos from products like Sketch, Principle, Invision, and more loosely tied together](/images/design-at-scale-one-year-with-figma/state-of-design-tools-2016.png)
...
![A variety of screens in Liferay’s 'My Projects' InVision dashboard](/images/design-at-scale-one-year-with-figma/liferay-invision-projects.png)
...
![A screenshot from Figma’s 'Getting Started' video on YouTube](/images/design-at-scale-one-year-with-figma/figma-overview-video-screenshot.png)
...
![A slide with about Liferay’s Digital Asset Management structure](/images/design-at-scale-one-year-with-figma/dam-at-liferay.jpeg)
...
![A screenshot showing Liferay’s system for organizing Figma projects](/images/design-at-scale-one-year-with-figma/figma-covers.png)
...
![An animated image a Figma project before and after the cover system](/images/design-at-scale-one-year-with-figma/figma-covers-in-action.gif)
...
![A screenshot showing Liferay’s reusabile utility components for redlining, and creating flows and affinity diagrams](/images/design-at-scale-one-year-with-figma/redlines-flow-affinity.png)
...
![Two screenshots showing different ways to name Figma pages](/images/design-at-scale-one-year-with-figma/pages-in-figma.png)
...
<Image
	...
	src="./images/design-at-scale-one-year-with-figma/figma-version-history-timeline.png"
	margin="0 0 0 4rem"
/>
...
![A diagram showing how restoring past versions of a Figma file works](/images/design-at-scale-one-year-with-figma/version-control.png)
_Git it?_
...
![A series of screenshots showing how offline editing works](/images/design-at-scale-one-year-with-figma/working-offline.png)
...
![A screenshot of Liferay’s open source Figma project](/images/design-at-scale-one-year-with-figma/open-source-design.png)
