...
<table>
  ...
  <tr>
    <td>
      <p>
        One of Lifery’s core features is content management. Many of our
        customers operate globally and need to provide content in multiple
        languages to serve their audiences effectively.
      </p>
    </td>
    <td>
      <ul>
    ...
    <td>
      <ul>
        <li>60% decrease in time spent on translation tasks</li>
        <li>20% increase in the System Usability Score (SUS)</li>
        <li>30% reduction in user error rates</li>
      </ul>
    </td>
  </tr>
</table>

<Image src="/projects/translation/cover-dark.jpg" width={1080} height={800} />
...
By continuously improving our localization capabilities, we aim to provide a seamless, efficient, and delightful experience for our global customers, empowering them to reach and engage with their audiences across languages and cultures effectively.

---

I'd lead with a different image or custom illustration that illustrates the issue more directly. Starting with a UI that I have never seen and don't yet understand is uninspiring to me.

For the conclusions, insights, questions section - it seems a bit odd you lead with conclusions first and then get to the insights and questions. What she different between an insight and a conclusion? Couldn't those be bundled together in some way. This section could benefit in better contrast on type form headers and body font as to me as a reader all the text here started to swirl together into one big text flood instead of being clearly delineated with good contrast or dividers. I'd made distance between rows consistent, negative space between top row is less than bottom row. Assuming because the text boxes themselves are qual inside but since the the text within is not it makes it unsightly.
