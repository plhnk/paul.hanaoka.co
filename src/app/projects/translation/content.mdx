...
<Summary
  context={
    'One of Lifery’s core features is content management. Many of our customers operate globally and need to provide content in multiple languages to serve their audiences effectively.'
  }
  contributions={[
    'User Research',
    'Product Strategy',
  ...
  impact={[
    '60% decrease in time on task',
    '20% increase in System Usability Score (SUS)',
    '30% reduction in user error rates',
  ]}
/>
