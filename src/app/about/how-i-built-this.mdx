Arguably one of the best shows ever on television &mdash; learning how things are made is always fascinating. Maybe you will find this fascinating.
...
- Components from Radix UI and Shadcn
  ...
  - I'm still getting used to it &mdash; I think I still prefer the mental model of ThemeUI? 
- Styled with TailwindCSS
  - I've been wanting to use Tailwind for awhile, this seemed like a great opportunity
  - Again &mdash; I think I may possibily prefer ThemeUI for styling / re-use, but I've actually really enjoyed how quickly I can work in Tailwind, getting 80% of the way in less than a minute
...
I was inspired by (TODO find link) to archive the different iterations of my site over the years. 
