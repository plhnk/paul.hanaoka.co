...
export default function Home() {
  return (
    <>
      <div className="col-span-1 flex flex-col justify-between pt-[6.9rem] h-fit sm:sticky top-[6.9rem] leading-normal h-full">
        <div>
      ...
      <div className="grid items-stretch sm:flex sm:flex-col grid-cols-2 row-span-2 sm:grid-cols-1 gap-4 sm:gap-8 mb-8">
